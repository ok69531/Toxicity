...
acute_path = '//*[@id="QU.SE.7.2-acute-toxicity-header"]/div/div[2]'
driver.find_element_by_xpath(acute_path).click()
time.sleep(0.5)

oral_path = '//*[@id="QU.SE.7.2-acute-toxicity"]/div/div/div[1]/div[3]/button'
...
tg420_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[11]'
driver.find_element_by_xpath(tg420_path).click()
time.sleep(0.5)

epa11_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[2]'
driver.find_element_by_xpath(epa11_path).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg420_page_src.json', 'w'))
