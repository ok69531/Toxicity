...
tg408_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[25]'
driver.find_element_by_xpath(tg408_path).click()
time.sleep(0.5)

epa31_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[6]'
driver.find_element_by_xpath(epa31_path).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg408_page_src.json', 'w'))
