...
tg413_path1 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[14]'
driver.find_element_by_xpath(tg413_path1).click()
time.sleep(0.5)

tg413_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[15]'
driver.find_element_by_xpath(tg413_path2).click()
time.sleep(0.5)

epa3465_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[3]'
driver.find_element_by_xpath(epa3465_path).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg413_page_src.json', 'w'))
