...
tg412_path1 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[12]'
driver.find_element_by_xpath(tg412_path1).click()
time.sleep(0.5)

tg412_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[13]'
driver.find_element_by_xpath(tg412_path2).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg412_page_src.json', 'w'))
