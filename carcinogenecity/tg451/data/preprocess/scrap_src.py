...
carcino_path = '//*[@id="QU.SE.7-toxicological-information"]/div/div/div/div[2]/button'
driver.find_element_by_xpath(carcino_path).click()
time.sleep(0.5)
...
tg451_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[9]'
driver.find_element_by_xpath(tg451_path).click()
time.sleep(0.5)

echa42_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[3]'
driver.find_element_by_xpath(echa42_path).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg451_page_src.json', 'w'))
