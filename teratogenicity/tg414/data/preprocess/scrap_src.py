...
tera_path = '//*[@id="QU.SE.7.8-toxicity-to-reproduction"]/div/div/div[2]/div[3]'
driver.find_element_by_xpath(tera_path).click()
time.sleep(0.5)
...
tg414_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[7]'
driver.find_element_by_xpath(tg414_path).click()
time.sleep(0.5)

epa37_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[3]'
driver.find_element_by_xpath(epa37_path).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg414_page_src.json', 'w'))
