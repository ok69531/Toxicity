...
repeat_path = '//*[@id="QU.SE.7.5-repeated-dose-toxicity-header"]/div/div[2]'
driver.find_element_by_xpath(repeat_path).click()
time.sleep(0.5)

dermal_path = '//*[@id="QU.SE.7.5-repeated-dose-toxicity"]/div/div/div[3]/div[3]/button'
driver.find_element_by_xpath(dermal_path).click()
time.sleep(0.5)
...
tg411_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[14]'
driver.find_element_by_xpath(tg411_path).click()
time.sleep(0.5)

epa325_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[5]'
driver.find_element_by_xpath(epa325_path).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg411_page_src.json', 'w'))
