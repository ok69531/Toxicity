...
driver.find_element_by_xpath(geno_path).click()
time.sleep(0.5)

vitro_path = '//*[@id="QU.SE.7.6-genetic-toxicity"]/div/div/div[1]/div[3]'
driver.find_element_by_xpath(vitro_path).click()
time.sleep(0.5)
...
driver.find_element_by_xpath(tg473_path1).click()
time.sleep(0.5)

tg473_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[36]'
driver.find_element_by_xpath(tg473_path2).click()
time.sleep(0.5)

epa5375_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[7]'
driver.find_element_by_xpath(epa5375_path).click()
time.sleep(0.5)
