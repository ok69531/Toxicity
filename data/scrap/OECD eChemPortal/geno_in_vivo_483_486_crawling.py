...
oecd_tg483_path = tg_path % 36
oecd_tg483_button = driver.find_element_by_xpath(oecd_tg483_path)
oecd_tg483_button.click()
time.sleep(0.3)


oecd_tg486_path = tg_path % 39
oecd_tg486_button = driver.find_element_by_xpath(oecd_tg486_path)
oecd_tg486_button.click()
time.sleep(0.3)
...
#%%
df.to_excel('oral420_423_425.xlsx', header = True, index = False)
