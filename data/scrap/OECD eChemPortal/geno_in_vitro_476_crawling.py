...
oecd_tg476b_path = tg_path % 38
oecd_tg476b_button = driver.find_element_by_xpath(oecd_tg476b_path)
oecd_tg476b_button.click()
time.sleep(0.3)


oecd_tg476f_path = tg_path % 39
oecd_tg476f_button = driver.find_element_by_xpath(oecd_tg476f_path)
oecd_tg476f_button.click()
time.sleep(0.3)


oecd_tg476o_path = tg_path % 48
oecd_tg476o_button = driver.find_element_by_xpath(oecd_tg476o_path)
oecd_tg476o_button.click()
time.sleep(0.3)
...
#%%
df.to_excel('geno_in_vitro_476.xlsx', header = True, index = False)
