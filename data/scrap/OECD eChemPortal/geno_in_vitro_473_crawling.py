...
oecd_tg473f_path = tg_path % 36
oecd_tg473f_button = driver.find_element_by_xpath(oecd_tg473f_path)
oecd_tg473f_button.click()
time.sleep(0.3)


tg_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[%d]' 
oecd_tg473b_path = tg_path % 37
oecd_tg473b_button = driver.find_element_by_xpath(oecd_tg473b_path)
oecd_tg473b_button.click()
time.sleep(0.3)


tg_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[%d]' 
oecd_tg473o_path = tg_path % 47
oecd_tg473o_button = driver.find_element_by_xpath(oecd_tg473o_path)
oecd_tg473o_button.click()
time.sleep(0.3)
