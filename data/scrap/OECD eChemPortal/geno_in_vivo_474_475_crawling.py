...
vivo_button_path = '//*[@id="QU.SE.7.6-genetic-toxicity"]/div/div/div[2]/div[3]/button'
vivo_button = driver.find_element_by_xpath(vivo_button_path)
vivo_button.click()
time.sleep(0.1)
...
oecd_tg474_path = tg_path % 30
oecd_tg474_button = driver.find_element_by_xpath(oecd_tg474_path)
oecd_tg474_button.click()
time.sleep(0.3)


oecd_tg475_path = tg_path % 31
oecd_tg475_button = driver.find_element_by_xpath(oecd_tg475_path)
oecd_tg475_button.click()
time.sleep(0.3)
...
#%%
df = pd.DataFrame(columns = {'Chem_Name', 'CasRN', 'Genotoxicity', 'Toxicity'})
df.columns = ['Chemical_Name'] + ['CasRN'] + ['Genotoxicity'] + ['Toxicity']
...
while p < page_length:
    ...
    for i in row_length:
        ...
        try: 
            ...
            try:
                vivo_path = '//*[@id="SubNav7_7_3"]'
                vivo_url = driver.find_element_by_xpath(vivo_path)
                vivo_url.click()
                time.sleep(0.1)
                ...
                try:
                    ...
                    if (ld_tmp[0] == 'Test results'):
                        ...
                        try:
                            panel_df = pd.DataFrame(columns = {'Chem_Name', 'CasRN', 'Genotoxicity', 'Toxicity'})
                            panel_df.columns = ['Chemical_Name'] + ['CasRN'] + ['Genotoxicity'] + ['Toxicity']
...
#%%
df.to_excel('geno_in_vitro_474_475.xlsx', header = True, index = False)
