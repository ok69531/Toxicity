...
oral_button_path = '//*[@id="QU.SE.7.2-acute-toxicity"]/div/div/div[1]/div[3]/button'
oral_button = driver.find_element_by_xpath(oral_button_path)
oral_button.click()
time.sleep(0.1)
...
oecd_tg420_path = tg_path % 9
oecd_tg420_button = driver.find_element_by_xpath(oecd_tg420_path)
oecd_tg420_button.click()
time.sleep(0.3)


oecd_tg423_path = tg_path % 10
oecd_tg423_button = driver.find_element_by_xpath(oecd_tg423_path)
oecd_tg423_button.click()
time.sleep(0.3)

oecd_tg425_path = tg_path % 11
oecd_tg425_button = driver.find_element_by_xpath(oecd_tg425_path)
oecd_tg425_button.click()
time.sleep(0.3)
...
while p < page_length:
    ...
    for i in row_length:
        ...
        try: 
            ...
            acute_path = '//*[@id="SubNav7_3_2"]'
            acute_button = driver.find_element_by_xpath(acute_path)
            acute_button.click()
            time.sleep(0.1)
            
            try:
                oral_path = '//*[@id="SubNav7_3_2"]'
                oral_url = driver.find_element_by_xpath(oral_path)
                oral_url.click()
                time.sleep(0.1)
