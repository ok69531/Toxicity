...
der_button_path = '//*[@id="QU.SE.7.2-acute-toxicity"]/div/div/div[3]/div[3]/button'
der_button = driver.find_element_by_xpath(der_button_path)
der_button.click()
time.sleep(0.1)
...
oecd_tg402_path1 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[%d]' % 7
oecd_tg402_button1 = driver.find_element_by_xpath(oecd_tg402_path1)
oecd_tg402_button1.click()
time.sleep(0.3)


oecd_tg402_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[%d]' % 8
oecd_tg402_button2 = driver.find_element_by_xpath(oecd_tg402_path2)
oecd_tg402_button2.click()
time.sleep(0.3)
...
while p <= page_length:
    ...
    for i in row_length:
        ...
        try: 
            ...
            try:
                der_path = '//*[@id="SubNav7_3_4"]/a'
                der_url = driver.find_element_by_xpath(der_path)
                der_url.click()
...
#%%
df.to_excel('dermal402.xlsx', header = True, index = False)
